    ...
    >
      <div className="flex items-center justify-between px-4 sm:px-6 lg:px-12 py-3 sm:py-4">
        ...
        <div className="flex items-center">
          <Link to="/">
            <h1
              className={`text-xl sm:text-2xl lg:text-3xl font-semibold tracking-wide transition-colors duration-300 ${
                navDark ? "text-white" : "text-black"
              }`}
            >
              Bharat
              <span className="text-red-600">Darshan</span>
            </h1>
          </Link>
        </div>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-black/90 backdrop-blur-sm px-4 py-4">
          <div className="flex flex-col space-y-4 text-white text-base font-light">
            ...
            <SignedOut>
              <SignInButton>
                <button className="flex items-center space-x-2 hover:text-gray-400 transition-colors">
                  <User className="w-5 h-5" />
                  <span>Sign In</span>
                </button>
              </SignInButton>
