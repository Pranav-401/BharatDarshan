      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="absolute top-32 left-12 z-20 max-w-3xl">
          <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <h1 className="text-6xl font-bold text-white drop-shadow-2xl mb-4 bg-gradient-to-r from-white to-orange-200 bg-clip-text">
        ...
        <div className="flex">
          <div className="flex-1 p-16">
            <div className="max-w-4xl">
              <h2 className="text-6xl font-bold bg-gradient-to-r from-orange-600 to-red-600 bg-clip-text text-transparent mb-12 leading-tight">
                A Legacy of Chola Grandeur
                <br />
                <span className="text-4xl">and Dravidian Architecture</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 border border-orange-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600">Chola Dynasty</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600">Designated in 1987</p>
                </div>
              </div>
              <div className="mb-12">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-red-50 rounded-2xl p-6 mb-8 border border-orange-100">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white/50 rounded-lg p-3">
                    <p className="text-gray-600 text-xs">Trichy Airport</p>
