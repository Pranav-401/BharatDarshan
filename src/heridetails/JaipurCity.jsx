...
const JaipurCity = () => {
  ...
  const EnhancedVideoCard = ({ video, index }) => (
    ...
    >
      ...
      <div className="p-5">
        <h4 className="font-bold text-gray-800 mb-2 line-clamp-2 group-hover:text-pink-600 transition-colors">
          {video.title}
        </h4>
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      >
        <ArrowLeft className="w-6 h-6 text-gray-700 group-hover:text-pink-600 transition-colors" />
      </button>
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <button
          onClick={prevImage}
          className="absolute left-8 top-1/2 transform -translate-y-1/2 text-white hover:text-pink-300 transition-all duration-300 z-20 bg-black/30 backdrop-blur-sm rounded-full p-4 hover:bg-black/50 hover:scale-110"
        >
          <ChevronLeft className="w-10 h-10" />
        </button>
        <button
          onClick={nextImage}
          className="absolute right-8 top-1/2 transform -translate-y-1/2 text-white hover:text-pink-300 transition-all duration-300 z-20 bg-black/30 backdrop-blur-sm rounded-full p-4 hover:bg-black/50 hover:scale-110"
        >
        ...
        <div className="absolute top-32 left-12 z-20 max-w-2xl">
          <div className="bg-black/20 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
            <h1 className="text-8xl font-bold text-white drop-shadow-2xl mb-4 bg-gradient-to-r from-white to-pink-200 bg-clip-text">
        ...
        <div className="flex">
          <div className="flex-1 p-16">
            <div className="max-w-4xl">
              <h2 className="text-6xl font-bold bg-gradient-to-r from-pink-600 to-orange-600 bg-clip-text text-transparent mb-12 leading-tight">
                The Pink City of Rajasthan
                <br />
                <span className="text-4xl">A Blend of Royalty and Culture</span>
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                <div className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-2xl p-6 border border-pink-100 hover:shadow-lg transition-all duration-300">
                  <div className="flex items-center gap-3 mb-3">
                    <Clock className="w-8 h-8 text-pink-600" />
                    <h3 className="font-bold text-xl text-gray-800">Founded</h3>
                  </div>
                  <p className="text-3xl font-bold text-pink-600 mb-1">1727</p>
                  <p className="text-sm text-gray-600">By Sawai Jai Singh II</p>
                </div>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-6 border border-green-100 hover:shadow-lg transition-all duration-300">
                  ...
                  <p className="text-sm text-gray-600">Jantar Mantar, 2010</p>
                </div>
              </div>
              <div className="mb-12">
                      ...
                      <button
                        ...
                        className={`group flex items-center space-x-3 px-6 py-3 rounded-2xl transition-all duration-500 hover:scale-105 ${
                          activeVideoCategory === category
                            ? "bg-gradient-to-r from-pink-500 to-orange-500 text-white shadow-2xl"
              ...
              <div className="mb-12">
                ...
                <div className="relative">
                  <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-pink-500 to-orange-500 rounded-full"></div>
                  {[
                    {
                      year: "1727",
            ...
            <div className="bg-gradient-to-br from-pink-50 to-orange-50 rounded-2xl p-6 mb-8 border border-pink-100">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white/50 rounded-lg p-3">
                    <p className="text-gray-600 text-xs">Jaipur Airport</p>
