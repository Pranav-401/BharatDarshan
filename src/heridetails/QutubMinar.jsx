...
const QutubMinar = () => {
  ...
  const videoContent = {
    historical: [
      {
        id: "https://youtu.be/5zYOKFjpm9s?si=3J5z1X9Y6b7k8c9d",
    ...
    mythology: [
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "The Iron Pillar Enigma",
        description: "Explore the legend of the rust-resistant Iron Pillar",
        duration: "11:20",
        views: "1.6M",
        rating: 4.6,
        category: "Legends",
      ...
      {
        id: "dQw4w9WgXcQ",
        title: "Spiritual Significance of Qutub",
        description:
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3 text-sm">
                  ...
                  <div className="bg-white/50 rounded-lg p-3">
                    ...
                    <p className="font-bold text-orange-600">15km away</p>
                  </div>
                </div>
                <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-lg p-3 border border-blue-200">
                  ...
                  <p className="text-xs text-blue-600 mt-1">
                    Take the Delhi Metro Yellow Line to Qutub Minar station (15
                    min walk)
                  </p>
                </div>
              </div>
